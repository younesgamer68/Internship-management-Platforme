...
<body x-data
    ...
    <section id="hero-section" class="relative z-0 mt-10 pt-10 pb-10 overflow-hidden bg-no-repeat bg-cover bg-center"
        ...
        <div
            ...
            <div class="animate-[fadeUp_0.65s_ease_both]">
                <h1
                    ...
                    Gain An Unbeatable Advantage with
                    <span class="text-[#00b1aa]">a Virtual Internship</span>
                </h1>
                <p class="mt-4 font-[Nunito] text-base font-semibold text-[#b6b3b3]">
                    We work with partners across the globe to provide you a guaranteed internship to enhance your
                    education experience.
                    <br>
                    Through our affiliate partnership, you'll have access to thousands of opportunities with real
                    companies all over the world, enabling you to gain valuable work experience and key skills for your
                    future career.
                </p>
            ...
            {{-- ── Right: YouTube video with thumbnail overlay ── --}}
            <div
                class="animate-[fadeRight_0.7s_0.1s_ease_both] justify-self-center md:justify-self-end md:w-full md:max-w-[400px]">

                {{-- Outer wrapper: aspect ratio + clip + shadow --}}
                <div class="relative w-full overflow-hidden rounded-2xl shadow-[0_16px_48px_rgba(0,0,0,0.18)]"
                    style="aspect-ratio: 16/9; background:#000;">

                    {{-- YouTube iframe — autoplay injected by JS on click --}}
                    <iframe id="hero-yt-player" src="https://www.youtube.com/embed/YOUR_VIDEO_ID?enablejsapi=1&rel=0"
                        allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                        allowfullscreen class="absolute inset-0 h-full w-full border-0">
                    </iframe>

                    {{-- Thumbnail overlay --}}
                    <div id="hero-yt-thumb"
                        class="group absolute inset-0 z-10 cursor-pointer transition-opacity duration-500" role="button"
                        aria-label="Play video" tabindex="0">

                        {{-- Thumbnail image — replace src with your thumbnail --}}
                        <img src="https://i.ytimg.com/vi/JVP8bXgNOmM/hq720.jpg?sqp=-oaymwEhCK4FEIIDSFryq4qpAxMIARUAAAAAGAElAADIQj0AgKJD&rs=AOn4CLBVB__Ca1wXOAm8oWSbqn4jV3e2VQ"
                            alt="Video thumbnail"
                            class="absolute inset-0 h-full w-full object-cover transition-transform duration-500 ease-out brightness-100 group-hover:scale-105 group-hover:brightness-75"
                            style="background:#ffffff;" />

                        {{-- Dark scrim (subtle, always visible) --}}
                        <div
                        ...
                        <div class="absolute inset-0 flex items-center justify-center">
                            <div class="flex h-16 w-16 items-center justify-center rounded-full bg-white/90 shadow-[0_8px_32px_rgba(0,0,0,0.35)]
                                    scale-75 opacity-0 transition-all duration-300 ease-out
                                    group-hover:scale-100 group-hover:opacity-100">
                                {{-- Play triangle --}}
                                <svg viewBox="0 0 24 24" class="h-7 w-7 fill-[#00b1aa] ml-1"
        ...
        <script>
            (function () {
                const thumb = document.getElementById('hero-yt-thumb');
                const player = document.getElementById('hero-yt-player');
                ...
                function startVideo() {
                    ...
                    // Append autoplay=1 to kick off playback
    ...
    <section class="w-full bg-[#ebebeb]  px-4 py-10 font-[Poppins] sm:px-8 sm:py-20 lg:px-5 lg:py-20">
        <div class="mx-auto flex w-full max-w-[1200px] flex-col items-center">
            <h2 id="proven-results-title"
                class="mb-5 text-center text-[clamp(1.8rem,5vw,2.8rem)] font-bold tracking-[-0.03em] text-[#444444] opacity-0 translate-y-[18px] transition-all duration-700 ease-out">
            ...
            <p
                ...
                Not only is internship experience essential to gain your advantage in the market, employers are now
                actively looking for graduates with remote work skills
            ...
            <div class="grid w-full grid-cols-1 gap-x-1 md:grid-cols-2 xl:grid-cols-3 xl:gap-y-0">
                <div class="stat-card flex flex-col items-center px-5 text-center opacity-0 translate-y-[22px] transition-all duration-700 ease-out "
                    data-delay="0">
                    <div class="stat-number mb-2.5 text-[clamp(2.4rem,5vw,3.4rem)] font-bold leading-none tracking-[-0.06em] text-[#00b1aa]"
                        data-target="85" data-suffix="%">%</div>
                    <div class="text-[0.78rem] font-normal text-[#888888]">more likely to obtain employment after
                        graduation if you complete an internship</div>
                </div>
                <div class="stat-card flex flex-col items-center px-5 text-center opacity-0 translate-y-[22px] transition-all duration-700 ease-out"
                    data-delay="240">
                    <div
                        class="stat-number mb-2.5 text-[clamp(2.4rem,5vw,3.4rem)] font-bold leading-none tracking-[-0.04em] text-[#8164eb]">
                        <span id="one-in-three">By 2026</span>
                    </div>

                    <div class="text-[0.78rem] font-normal text-[#888888]">73% of all departments in US companies will
                        have remote workers</div>
                </div>
                ...
                <div class="stat-card flex flex-col items-center px-5 text-center opacity-0 translate-y-[22px] transition-all duration-700 ease-out"
                    ...
                    <div class="text-[0.78rem] font-normal text-[#888888]">VI interns get offered a position with their
                        host company immediately upon completion</div>
                </div>
