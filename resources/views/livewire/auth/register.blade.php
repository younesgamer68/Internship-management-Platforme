<x-layouts.split-auth title="Sign up">
    ...
    <div class="space-y-4">
        <a href="{{ route('auth.google') }}"
            class="w-full flex items-center justify-center gap-3 px-4 py-2.5 border border-gray-200 rounded-lg shadow-sm bg-white hover:bg-gray-100 text-gray-700 font-medium transition-all duration-200 group">
        ...
        <div>
            ...
            <div class="relative">
                ...
                <button type="button" onclick="togglePassword(this)"
                    ...
                    style="z-index: 50;" title="Toggle password visibility">
                    <svg class="h-5 w-5 pointer-events-none icon-show" xmlns="http://www.w3.org/2000/svg" fill="none"
                    ...
                    <svg class="h-5 w-5 pointer-events-none icon-hide" style="display: none;"
        ...
        <div class="flex items-start">
            ...
            <div class="ml-2 text-sm text-gray-600">
                I agree to the <a href="#" class="font-medium text-green-600 hover:text-green-500">Terms of
                    Service</a> and <a href="#" class="font-medium text-green-600 hover:text-green-500">Privacy
                    Policy</a>
            </div>
        </div>
