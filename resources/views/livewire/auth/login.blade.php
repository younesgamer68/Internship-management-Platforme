    ...
    <div class="mb-8">
        ...
        <p class="mt-2 text-sm text-gray-600">
            ...
            <a href="{{ route('choose_path') }}"
                class="font-medium text-green-600 hover:text-green-500 transition-colors underline">Create your
                account</a>
        </p>
    </div>
        ...
        <div>
            ...
            <div class="relative">
                ...
                <button type="button" onclick="togglePassword(this)"
                    ...
                    <svg class="h-5 w-5 pointer-events-none icon-hide hidden" xmlns="http://www.w3.org/2000/svg"
