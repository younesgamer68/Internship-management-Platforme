<div>
    ...
    <style>
        ...
        @keyframes cw-header-gradient-flow {
            from {
                background-position: 0% 50%;
            }
        ...
        .cw-header-gradient-flow {
            background-size: 200% 200%;
            animation: cw-header-gradient-flow 8s ease-in-out infinite alternate;
        }
        ...
        .cw-msg-enter {
            animation: cw-msg-in 0.3s ease-out forwards;
        }
        ...
        .cw-pulse-ring::before {
            ...
            background: linear-gradient(135deg, #17494D, #1b7a44);
    ...
    <div x-data="{
                ...
                <div
                    ...
                    <div class="relative z-10 flex items-center gap-2.5">
                        <div class="flex h-9 w-9 items-center justify-center rounded-xl  p-1">
                            <img src="{{ asset('images/Logos/Small Logo.png') }}" alt="Helpdesk"
                    ...
                    <p class="relative z-10 mt-2 text-[12px] leading-snug text-white/85" x-text="currentWelcomeText"></p>
                </div>

                {{-- Conversation list --}}
                <div
                    class="cw-animated-bg flex-1 overflow-y-auto [&::-webkit-scrollbar]:w-[3px] [&::-webkit-scrollbar-thumb]:rounded-full [&::-webkit-scrollbar-thumb]:bg-[#1b7a44]/30">
                ...
                <div class="shrink-0 border-t border-gray-200 bg-gray-50 py-2">
                    <div class="flex items-center justify-center gap-2">
                        <div class="flex h-3 w-3 items-center justify-center">
                            <img src="{{ asset('images/Logos/Small Logo.png') }}" alt="InterLink"
        ...
        <button @click="toggle()" type="button"
            ...
            <img x-show="!isOpen" src="{{ asset('images/Logos/Small Logo.png') }}" alt="Chat"
