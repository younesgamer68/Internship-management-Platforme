<div class="company-dashboard-wrapper"><div>
  <style>
    /* ── Welcome Banner ── */
    .welcome-banner {
  ...
  <script>
    ...
    function renderApplicants() {
      ...
      <div class="applicant-info">
        ...
        <div class="applicant-role"><i class="fas fa-briefcase" style="font-size:.68rem;margin-right:4px;"></i>${a.role}</div>
        <div class="applicant-tags">${tagHtml}</div>
      </div>
      <span class="status-badge ${state.toLowerCase()}">${state}</span>
      <div class="applicant-actions">
        <button class="btn-xs view" onclick="openApplicant(event,${i})"><i class="fas fa-eye"></i> <span>View</span></button>
