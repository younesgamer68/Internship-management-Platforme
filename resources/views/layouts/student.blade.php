...
<head>
    ...
    <style>
        ...
        .sidebar.collapsed .sidebar-logo .logo-small { display:block !important; }
        ...
        .page-enter-target.entered { opacity:1; transform:translateY(0); }
        ...
        .topbar-icon-btn:hover { background:var(--primary-bg) !important; color:var(--primary) !important; border-color:var(--primary) !important; }
        .user-avatar-btn:hover  { background:var(--primary-bg) !important; border-color:var(--primary) !important; }
        .card-link { color:var(--primary) !important; }
        .card-link:hover { color:var(--primary-dark) !important; }
    </style>
    @livewireStyles
    @fluxAppearance
</head>
    ...
    <div class="sidebar-bottom">
      <div class="sidebar-user">
        ...
        <a href="#" onclick="event.preventDefault();document.getElementById('logout-form-sidebar').submit();"
           title="Log Out"
           style="color:rgba(255,255,255,0.5);font-size:14px;transition:color 0.2s;margin-left:auto;"
  ...
  <div class="main-content">
    <header class="topbar">
      ...
      <div class="topbar-right">
        <button type="button" class="topbar-icon-btn" id="dark-mode-toggle" title="Toggle dark mode" onclick="toggleGlobalDarkMode()" style="border-radius: 10px; cursor: pointer; display: flex; align-items: center; justify-content: center; outline: none; border: 1px solid var(--border);">
        ...
        <div class="user-avatar-btn">
          ...
          <form id="logout-form-topbar" method="POST" action="{{ route('logout') }}" style="display:none;">@csrf</form>
