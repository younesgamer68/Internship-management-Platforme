<x-layouts::company title="Platform Settings">
...
const PROFILE_DEFAULTS = {
  ...
  founded: '2012',
  hq: 'New York, USA',
  description: 'TechSolutions Inc. is a leading technology company specializing in enterprise software development, cloud infrastructure, and digital transformation services. We are committed to innovation and building the next generation of tech talent through our internship programs.',
};
...
function saveProfile() {
  const data = {
    ...
    founded: document.getElementById('c-founded').value,
  ...
  showSettingsToast('Profile settings saved!');
  triggerAutosaveBadge();
}
...
function resetProfile() {
  ...
  loadProfile();
  showSettingsToast('Profile reset to defaults.', 'info');
}
