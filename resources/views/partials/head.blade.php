...
<script>
    if (!localStorage.getItem('flux.appearance')) localStorage.setItem('flux.appearance', 'light');
</script>
@fluxAppearance
...
<style>
    ...
    .swal-custom .swal2-icon.swal2-warning {
        color: #ef4444 !important;
    }

    .swal-custom .swal2-icon.swal2-warning .swal2-icon-content {
        color: #ef4444 !important;
    }
