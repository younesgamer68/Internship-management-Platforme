...
<body class="bg-gray-50 min-h-screen text-gray-900 antialiased">
    ...
    <section class="flex min-h-screen bg-gray-50 font-sans">
        ...
        <aside
            ...
            <nav class="flex flex-col gap-1 flex-1">
                ...
                @foreach ($navItems as $item)
                    @if(in_array($item['label'], ['Applications', 'Opportunities', 'Career Field']))
        ...
        <div class="ml-56 flex-1 p-6 min-h-screen">
            ...
            {{-- Back button --}}
            <a href="{{ route('intern.opportunities') }}"
                ...
                <div class="bg-white rounded-2xl border border-gray-100 shadow-sm p-6 mb-6">
                    ...
                    <div class="flex flex-col gap-0 ml-2">
                        ...
                        <div class="relative flex items-start gap-4 pb-5">
                            <div
                                style="position: absolute; left: 15px; top: 32px; bottom: -8px; width: 2px; background: #e5e7eb;">
                            </div>
                            <div
                                class="relative z-10 w-8 h-8 rounded-full border-2 border-teal-500 bg-teal-500 flex items-center justify-center flex-shrink-0">
                            ...
                            <div class="pt-1">
                                <p class="text-[10px] font-bold uppercase tracking-wider" style="color: #7b7b7b">Step 1
                                </p>
                                <p class="text-sm font-semibold mt-0.5" style="color: #444444">Complete your application
                                    & profile</p>
                            </div>
                        </div>
                        ...
                        <div class="relative flex items-start gap-4 pb-5">
                            ...
                            <div class="pt-1">
                                <p class="text-[10px] font-bold uppercase tracking-wider" style="color: #7b7b7b">Step 2
                                </p>
                                <p class="text-sm font-semibold mt-0.5" style="color: #444444">We'll review & approve
                                    your application</p>
                            </div>
                        </div>
                        ...
                        <div class="relative flex items-start gap-4 pb-5">
                            ...
                            <div class="pt-1">
                                <p class="text-[10px] font-bold uppercase tracking-wider" style="color: #7b7b7b">Step 3
                                </p>
            ...
            <div class="max-w-3xl mx-auto">
                ...
                <div class="bg-white rounded-2xl border border-gray-100 shadow-sm p-5 mb-6">
                    ...
                    <div class="w-full h-2 bg-gray-100 rounded-full overflow-hidden">
                        <div id="progressBar"
                            class="progress-fill h-full bg-gradient-to-r from-teal-400 to-teal-600 rounded-full"
                            style="width: 25%"></div>
                    </div>
                    ...
                    <div class="flex items-center justify-between mt-5">
                        <button onclick="goToStep(0)" class="flex flex-col items-center gap-1.5 group cursor-pointer">
                            <div class="step-dot w-8 h-8 rounded-full border-2 border-gray-200 bg-white flex items-center justify-center text-xs font-bold text-gray-400 active"
                                data-step="0">
                                <svg class="w-4 h-4 hidden" fill="none" stroke="white" stroke-width="2.5"
                                    viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M5 13l4 4L19 7" />
                                </svg>
                                <span>1</span>
                            ...
                            <span
                                class="text-[10px] font-semibold text-gray-500 group-hover:text-teal-600 transition-colors">Personal</span>
                        </button>
                        ...
                        <button onclick="goToStep(1)" class="flex flex-col items-center gap-1.5 group cursor-pointer">
                            <div class="step-dot w-8 h-8 rounded-full border-2 border-gray-200 bg-white flex items-center justify-center text-xs font-bold text-gray-400"
                                data-step="1">
                                <svg class="w-4 h-4 hidden" fill="none" stroke="white" stroke-width="2.5"
                                    viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M5 13l4 4L19 7" />
                            ...
                            <span
                                class="text-[10px] font-semibold text-gray-500 group-hover:text-teal-600 transition-colors">Education</span>
                        </button>
                        ...
                        <button onclick="goToStep(2)" class="flex flex-col items-center gap-1.5 group cursor-pointer">
                            ...
                            <span
                                class="text-[10px] font-semibold text-gray-500 group-hover:text-teal-600 transition-colors">Experience</span>
                        </button>
                        ...
                        <button onclick="goToStep(3)" class="flex flex-col items-center gap-1.5 group cursor-pointer">
                            ...
                            <span
                                class="text-[10px] font-semibold text-gray-500 group-hover:text-teal-600 transition-colors">Motivation</span>
                        </button>
                    </div>
                </div>

                {{-- Form --}}
                <form id="internForm" action="{{ route('intern.application.store') }}" method="POST"
                        ...
                        <div class="bg-white rounded-2xl border border-gray-100 shadow-sm p-6 mb-6">
                            ...
                            <div class="grid grid-cols-2 gap-4">
                                <div class="form-group">
                                    <label
                                        class="block text-xs font-semibold text-gray-500 uppercase tracking-wider mb-1.5">First
                                ...
                                <div class="form-group">
                                    <label
                                        class="block text-xs font-semibold text-gray-500 uppercase tracking-wider mb-1.5">Last
                                        Name <span class="text-red-400">*</span></label>
                            ...
                            <div class="grid grid-cols-2 gap-4 mt-4">
                                <div class="form-group">
                                    <label
                                        class="block text-xs font-semibold text-gray-500 uppercase tracking-wider mb-1.5">Date
                                        of Birth <span class="text-red-400">*</span></label>
                                    <input type="date" name="date_of_birth" value="{{ old('date_of_birth') }}" required
                                        class="form-input w-full px-4 py-2.5 rounded-xl border border-gray-200 text-sm text-gray-800 outline-none">
                                </div>
                                <div class="form-group">
                                    <label
                                        class="block text-xs font-semibold text-gray-500 uppercase tracking-wider mb-1.5">Gender</label>
                                    <select name="gender"
                                        class="form-input w-full px-4 py-2.5 rounded-xl border border-gray-200 text-sm text-gray-800 outline-none bg-white">
                            ...
                            <div class="grid grid-cols-2 gap-4 mt-4">
                                <div class="form-group">
                                    <label
                                        class="block text-xs font-semibold text-gray-500 uppercase tracking-wider mb-1.5">Country
                    ...
                    <div class="form-section" data-section="1">
                        <div class="bg-white rounded-2xl border border-gray-100 shadow-sm p-6 mb-6">
                            ...
                            <div class="form-group mb-4">
                                <label
                                    class="block text-xs font-semibold text-gray-500 uppercase tracking-wider mb-1.5">University
                                    / Institution <span class="text-red-400">*</span></label>
                            ...
                            <div class="grid grid-cols-2 gap-4 mb-4">
                                <div class="form-group">
                                    <label
                                        class="block text-xs font-semibold text-gray-500 uppercase tracking-wider mb-1.5">Degree
                                        <span class="text-red-400">*</span></label>
                                    <select name="degree" required
                                        class="form-input w-full px-4 py-2.5 rounded-xl border border-gray-200 text-sm text-gray-800 outline-none bg-white">
                                        <option value="">Select…</option>
                                        <option value="high_school" {{ old('degree') == 'high_school' ? 'selected' : '' }}>High School Diploma</option>
                                        <option value="associate" {{ old('degree') == 'associate' ? 'selected' : '' }}>
                                            Associate's Degree</option>
                                        <option value="bachelor" {{ old('degree') == 'bachelor' ? 'selected' : '' }}>
                                            Bachelor's Degree</option>
                                        <option value="master" {{ old('degree') == 'master' ? 'selected' : '' }}>Master's
                                            Degree</option>
                                        <option value="phd" {{ old('degree') == 'phd' ? 'selected' : '' }}>PhD</option>
                                        <option value="other" {{ old('degree') == 'other' ? 'selected' : '' }}>Other
                                        </option>
                                    </select>
                                </div>
                                <div class="form-group">
                                    <label
                                        class="block text-xs font-semibold text-gray-500 uppercase tracking-wider mb-1.5">Field
                                        of Study <span class="text-red-400">*</span></label>
                                    <input type="text" name="field_of_study"
                                        value="{{ old('field_of_study', auth()->user()->career_field ?? '') }}" required
                                        class="form-input w-full px-4 py-2.5 rounded-xl border border-gray-200 text-sm text-gray-800 placeholder-gray-300 outline-none"
                            ...
                            <div class="grid grid-cols-2 gap-4 mb-4">
                                <div class="form-group">
                                    <label
                                        class="block text-xs font-semibold text-gray-500 uppercase tracking-wider mb-1.5">Start
                                        Year <span class="text-red-400">*</span></label>
                                    <input type="number" name="education_start_year"
                                        value="{{ old('education_start_year') }}" min="2000" max="2030" required
                                        class="form-input w-full px-4 py-2.5 rounded-xl border border-gray-200 text-sm text-gray-800 placeholder-gray-300 outline-none"
                                        placeholder="2022">
                                </div>
                                <div class="form-group">
                                    <label
                                        class="block text-xs font-semibold text-gray-500 uppercase tracking-wider mb-1.5">Expected
                                        Graduation</label>
                                    <input type="number" name="education_end_year"
                                        value="{{ old('education_end_year') }}" min="2000" max="2035"
                                        class="form-input w-full px-4 py-2.5 rounded-xl border border-gray-200 text-sm text-gray-800 placeholder-gray-300 outline-none"
                                        placeholder="2026">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <label
                                    class="block text-xs font-semibold text-gray-500 uppercase tracking-wider mb-1.5">GPA
                                    (Optional)</label>
                    ...
                    <div class="form-section" data-section="2">
                        <div class="bg-white rounded-2xl border border-gray-100 shadow-sm p-6 mb-6">
                            ...
                            <div class="form-group mb-4">
                                <label
                                    class="block text-xs font-semibold text-gray-500 uppercase tracking-wider mb-1.5">Previous
                                    Experience</label>
                            ...
                            <div class="form-group mb-4">
                                <label
                                    class="block text-xs font-semibold text-gray-500 uppercase tracking-wider mb-1.5">Key
                                    Skills <span class="text-red-400">*</span></label>
                            ...
                            <div class="form-group mb-4">
                                <label
                                    class="block text-xs font-semibold text-gray-500 uppercase tracking-wider mb-1.5">LinkedIn
                                    Profile</label>
                            ...
                            <div class="form-group mb-4">
                                <label
                                    class="block text-xs font-semibold text-gray-500 uppercase tracking-wider mb-1.5">Portfolio
                                    / Website</label>
                            ...
                            <div class="form-group">
                                <label
                                    class="block text-xs font-semibold text-gray-500 uppercase tracking-wider mb-1.5">Upload
                                    Resume / CV <span class="text-gray-400 font-normal">(Optional)</span></label>
                                <div id="uploadZone"
                                    class="upload-zone border-2 border-dashed border-gray-200 rounded-xl p-6 text-center cursor-pointer"
                                    onclick="document.getElementById('resumeInput').click()">
                                    <input type="file" name="resume" id="resumeInput" class="hidden"
                                        accept=".pdf,.doc,.docx">
                                    ...
                                    <p id="uploadText" class="text-xs text-gray-400">
                                        <span class="text-teal-600 font-semibold">Click to upload</span> or drag and
                                        drop
                                    </p>
                    ...
                    <div class="form-section" data-section="3">
                        <div class="bg-white rounded-2xl border border-gray-100 shadow-sm p-6 mb-6">
                            ...
                            <div class="form-group mb-4">
                                <label
                                    class="block text-xs font-semibold text-gray-500 uppercase tracking-wider mb-1.5">Why
                                    do you want this internship? <span class="text-red-400">*</span></label>
                            ...
                            <div class="grid grid-cols-2 gap-4 mb-4">
                                <div class="form-group">
                                    <label
                                        class="block text-xs font-semibold text-gray-500 uppercase tracking-wider mb-1.5">Preferred
                                        Start Date <span class="text-red-400">*</span></label>
                                    <input type="date" name="preferred_start_date"
                                        value="{{ old('preferred_start_date') }}" required
                                        class="form-input w-full px-4 py-2.5 rounded-xl border border-gray-200 text-sm text-gray-800 outline-none">
                                </div>
                                <div class="form-group">
                                    <label
                                        class="block text-xs font-semibold text-gray-500 uppercase tracking-wider mb-1.5">Availability
                                        <span class="text-red-400">*</span></label>
                            ...
                            <div class="form-group mb-4">
                                <label
                                    class="block text-xs font-semibold text-gray-500 uppercase tracking-wider mb-1.5">How
                            ...
                            <div class="flex items-start gap-3 mt-6 p-4 bg-gray-50 rounded-xl border border-gray-100">
                                <input type="checkbox" name="agree_terms" id="agreeTerms" required
                                    class="mt-0.5 w-4 h-4 accent-teal-600 rounded">
                                <label for="agreeTerms" class="text-xs text-gray-500 leading-relaxed">
                                    I confirm that the information provided is accurate and I agree to the
                                    <a href="#" class="text-teal-600 hover:text-teal-700 font-semibold">Terms of
                                        Service</a> and
                                    <a href="#" class="text-teal-600 hover:text-teal-700 font-semibold">Privacy
                                        Policy</a>.
                                </label>
                            </div>
                        </div>
                    ...
                    <div class="flex items-center justify-between mb-10">
                        <button type="button" id="prevBtn" onclick="changeStep(-1)"
                            class="hidden items-center gap-2 px-5 py-2.5 rounded-xl border border-gray-200 bg-white text-sm font-semibold text-gray-600 hover:bg-gray-50 transition-colors">
                        ...
                        <button type="button" id="nextBtn" onclick="changeStep(1)"
                            class="inline-flex items-center gap-2 px-6 py-2.5 rounded-xl bg-teal-600 hover:bg-teal-700 text-white text-sm font-semibold transition-colors shadow-sm">
                            Continue
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                        ...
                        <button type="submit" id="submitBtn"
                            class="hidden items-center gap-2 px-6 py-2.5 rounded-xl bg-teal-600 hover:bg-teal-700 text-white text-sm font-semibold transition-colors shadow-sm">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M5 13l4 4L19 7" />
                            </svg>
                            Submit Application
