<footer
    ...
    <div class="relative z-10 flex flex-wrap items-center justify-between gap-5 pb-7 pt-6">
        ...
        <div class="flex flex-col items-end gap-4">
            ...
            <div class="flex items-center gap-3.5">
                <div
                    class="flex h-14 w-12 flex-col items-center justify-center gap-0.5 rounded-md border border-white/10 p-1.25">
                    <div class="text-[7px] uppercase tracking-[0.5px] text-[#5a6a7a]">Certified</div>
                    <div
                        class="flex h-6.5 w-6.5 items-center justify-center rounded-full border-2 border-[#5a6a7a] text-[13px] font-bold text-[#7a8a9a]">
                        B</div>
                    <div class="text-center text-[5.5px] tracking-[0.3px] text-[#4a5a6a]">Corporation</div>
                </div>

                <div
                    class="flex h-14 w-13 flex-col items-center justify-center gap-px rounded-md border border-white/10 p-1.5">
                    <div class="text-[7px] uppercase tracking-[0.5px] text-[#5a6a7a]">Pledge</div>
                    <div class="text-[22px] font-bold leading-none text-[#7a8a9a]">1</div>
                    <div class="text-xs font-semibold leading-none text-[#7a8a9a]">%</div>
                </div>
            </div>
